    ...
    for(int r = 0; r < height; r++) {
        if (col % 2 == 0 && width % 2 == 0) {
            ...
            if (width > 1) {
                ...
                // if bullet is <= 1 (since subtracting by 1), just setPixel
                setPixel4(row + r, col + width - 1, colorIndex);
            }
        } else if (col % 2 != 0 && width % 2 != 0) {
            ...
            if (width > 2) {
                ...
                // if bullet is <= 2 (since subtracting by 2), just setPixel
                setPixel4(row + r, col, colorIndex);
                setPixel4(row + r, col + width - 1, colorIndex);
            }
        }

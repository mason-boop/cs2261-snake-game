...
SOURCES            = main.c game.c myLib.c font.c text.c snake.c apple.c
CCPATH             = /usr/bin
DKPATH             = /Users/masondominey/cs2261/GBA/devkitARM/bin
VBASIM             = open /Users/masondominey/cs2261/GBA/visualboyadvance-m.app
FIND               = find
COPY               = cp -r
